...
public abstract class ArrayList<T> implements ListADT<T>, Iterable<T>
{
	...
	private class ArrayListIterator implements Iterator<T>
	{
		 ...
		 *          in the iteration
		 * @throws  java.util.ConcurrentModificationException if the collection has changed
		 ...
		 * @throws  java.util.NoSuchElementException if an element not found exception occurs
		 * @throws  java.util.ConcurrentModificationException if the collection has changed
		 */
